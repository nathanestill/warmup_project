...
class ObstacleAvoidState(object):

	def __init__(self):
		rospy.init_node("ObstacleAvoidState")
	...
	def routeRobot(self):
		...
		self.pub.publish(TwistStamped(header=Header(frame_id="obstacleavoid"),twist=velCmd))
